...
- remaining hidden/global wiring outside scheduled delivery/repository selection/delivery config-time/RichMenu config/scheduled trigger config/activation policy/audit timestamp seams remains open
