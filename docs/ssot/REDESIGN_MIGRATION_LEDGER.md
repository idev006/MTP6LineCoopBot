...
| LINE webhook ingress | direct LINE → Apps Script + downstream shared secret only | Verified Node ingress → signature verification → Apps Script downstream gate | CODE_VERIFIED / CUTOVER PENDING | gateway 110de3e CI #1; Apps Script privacy 9019873 CI #135; verifier parity 74d8a447 CI #9/#10; deployment-contract drift guard b1de92da CI #11/#12; base-image digest pin 94839c90 CI #13/#14; secure downstream transport 4947bed7 CI #15/#16; public response boundary 74188a7a CI #17/#18; deterministic body-limit boundary 3e655d51 PR CI #21/main CI #22; GitHub Actions immutable pins c80417f4 PR CI #23/main CI #24; slow-client timeout boundary 51075b6c PR CI #25/main CI #26; pre-body signature boundary 6dcb1b40 PR CI #28/main CI #29; bounded downstream timeout 3eb75cd7 PR CI #30/main CI #31; gateway secret independence @ f8e1db76 PR CI #32/main CI #33; immutable image publish #13: ghcr.io/idev006/mtp6linecoopbot-webhook-ingress:sha-f8e1db769d5f / ghcr.io/idev006/mtp6linecoopbot-webhook-ingress@sha256:30f32c3d88b59001cdf17a9e872882d82e5923ddd651a50406fc893aa4d0cbde | run repeatable verifier in staging and prove invalid traffic does not reach Apps Script + valid traffic reaches EventHandler; then LINE Console production cutover/monitoring before retiring direct ingress as supported production path |
