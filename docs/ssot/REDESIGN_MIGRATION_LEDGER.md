...
| LIFF identity | client lineUserId | Line ID Token Identity Adapter | MIGRATED | verifier @ 865569b; LIFF switch @ d3deac7; secure activation @ 3f052961/e174e625; legacy activation retirement @ cc70d58b CI #126 | legacy renewal compatibility remains under SEC-LEGACY-001 |
...
| Legacy member read routes | client/API-key lineUserId GET profile/savings/loans/dividends/validity | verified Principal + application use cases | RETIRED | backend 95d4f66 CI #115; legacy activation retired cc70d58b CI #126 | keep retirement guards; legacy renewal remains separate compatibility concern |
