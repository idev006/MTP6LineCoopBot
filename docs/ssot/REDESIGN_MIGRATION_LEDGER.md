...
| Web automated testing | no automated auth/security/build/component baseline | headless + router/store + component integration + security + production build gates | MIGRATED / ACTIVE WEB BASELINE VERIFIED | component SSR integration @ 38964de Webapp CI #36 PASS; existing engine/API/security/build gates retained | keep component integration representative and add focused regression cases with new protected UI behavior; deployment smoke remains release evidence |
...
| Documentation SSOT | duplicated backend `app/docs/*.md` project copies | canonical `MTP6LineCoopBot/docs/ssot` + backend pointer only | MIGRATED / DUPLICATE COPIES RETIRED | backend substantive copies retired + README pointer + CI governance guard @ c7df357 CI #198 PASS | keep project architecture/security/process/release/traceability docs canonical in this repo; backend may retain pointer-only navigation |
...
| LINE webhook ingress | direct LINE → Apps Script + downstream shared secret only | Verified Node ingress → signature verification → Apps Script downstream gate | CODE_VERIFIED / CUTOVER PENDING | gateway 110de3e CI #1; Apps Script privacy 9019873 CI #135; verifier parity 74d8a447 CI #9/#10; deployment-contract drift guard b1de92da CI #11/#12; base-image digest pin 94839c90 CI #13/#14; secure downstream transport 4947bed7 CI #15/#16; public response boundary 74188a7a CI #17/#18; deterministic body-limit boundary 3e655d51 PR CI #21/main CI #22; GitHub Actions immutable pins c80417f4 PR CI #23/main CI #24; slow-client timeout boundary 51075b6c PR CI #25/main CI #26; pre-body signature boundary 6dcb1b40 PR CI #28/main CI #29; bounded downstream timeout 3eb75cd7 PR CI #30/main CI #31; gateway secret independence f8e1db76 PR CI #32/main CI #33; native Node 24 release actions @ 352fc705 PR CI #34/main CI #35; immutable image publish #14: ghcr.io/idev006/mtp6linecoopbot-webhook-ingress:sha-352fc705612c / ghcr.io/idev006/mtp6linecoopbot-webhook-ingress@sha256:22ca6733eea5d1747bd2ecf52a5dbc060e173d1281ba5ef85f340e0d1fb99f8e | run repeatable verifier in staging and prove invalid traffic does not reach Apps Script + valid traffic reaches EventHandler; then LINE Console production cutover/monitoring before retiring direct ingress as supported production path |
