...
| LINE webhook ingress | direct LINE → Apps Script + downstream shared secret only | Verified Node ingress → signature verification → Apps Script downstream gate | CODE_VERIFIED / CUTOVER PENDING | gateway 110de3e CI #1; Apps Script privacy 9019873 CI #135; verifier parity 74d8a447 CI #9/#10; deployment-contract drift guard b1de92da CI #11/#12; base-image digest pin @ 94839c90 CI #13/#14; base sha256:e67514e5d0f6c46656005e1b693b2ec9d52e80b641307de684d4a015ba7a4eaf; immutable image publish #5: ghcr.io/idev006/mtp6linecoopbot-webhook-ingress:sha-94839c90d340 / ghcr.io/idev006/mtp6linecoopbot-webhook-ingress@sha256:e7e567e14b155d8bfd093878297361e9a7baedc10108c3571e3550d1d5ef1b33 | run repeatable verifier in staging and prove invalid traffic does not reach Apps Script + valid traffic reaches EventHandler; then LINE Console production cutover/monitoring before retiring direct ingress as supported production path |
