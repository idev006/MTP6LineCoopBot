...
| Repository contract | Data.MemberRepository mixed contract/factory + legacy policy-bearing activation/renewal operations | MemberRepositoryPort + composition | MIGRATED / LEGACY FACTORY + POLICY HELPERS + ACTIVATION + RENEWAL POLICY SEAMS RETIRED | f06dfb5 CI #41; InMemoryMemberRepository @ 255d862 CI #60 PASS; factory retirement @ 582b73c CI #154 PASS; policy-helper retirement @ c8491f7 CI #156 PASS; activation policy seam @ 8a3e55a CI #164 PASS; renewal policy seam @ 7cf0583 CI #177 PASS | keep reusable adapter contracts and deterministic saveActivation/saveRenewal persistence seams; persistence must not own activation/renewal policy or identity binding |
| Clock/time | new Date() in multiple flows | ClockPort | PARTIAL / DELIVERY + REPOSITORY ACTIVATION + DURABLE AUDIT + FUNCTIONAL CORE WALL-CLOCK RETIRED | de7fc1f CI #43; delivery wiring d338068 CI #158 PASS; activation policy seam retirement 8a3e55a CI #164 PASS; audit timestamp authority 4073c78 CI #169 PASS; Core determinism 2a1f4bb CI #171 PASS | keep ClockPort in engines/application; remaining date constructors must be input-derived only; audit identifier generation remains separate |
