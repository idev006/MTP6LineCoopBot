...
| Config | Config.get/validate globals | ConfigPort | PARTIAL / DELIVERY + RICHMENU GLOBALS RETIRED | ConfigPort + AppsScriptConfigAdapter @ 58ee3d9 CI #67 PASS; delivery wiring d338068 CI #158 PASS; RichMenu validated wiring b5a8d36 CI #160 PASS | keep SystemFactory ConfigPort authority; continue auditing remaining direct config globals outside verified sub-scopes |
