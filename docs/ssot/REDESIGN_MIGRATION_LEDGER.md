...
| Clock/time | new Date() in multiple flows | ClockPort | PARTIAL / DELIVERY GLOBAL + REPOSITORY ACTIVATION WALL-CLOCK RETIRED | de7fc1f CI #43; delivery wiring d338068 CI #158 PASS; activation policy seam retirement 8a3e55a CI #164 PASS | keep ClockPort in engines/application; continue auditing remaining non-policy date construction and audit timestamps separately |
