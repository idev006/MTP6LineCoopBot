...
| Repository contract | Data.MemberRepository mixed contract/factory | MemberRepositoryPort + composition | PARTIAL / LEGACY FACTORY RETIRED | f06dfb5, CI #41; InMemoryMemberRepository @ 255d862, CI #60 PASS; factory retirement @ 582b73c CI #154 PASS | keep reusable adapter contracts; repository policy helpers remain separate cleanup under BL-ARCH-003 |
