...
| Web frontend | direct fetches + client API key/mock fallbacks | shared session-authorized API clients + presentation-only UI | PARTIAL / MEMBER + SETTINGS READS MIGRATED | member reads backend d78a1bc CI #87 + frontend 07ca08e CI #11; admin settings backend 3ea0171 CI #92 + frontend 60b4d35 CI #13 | migrate Audit/Report/write/admin paths; remove remaining client API-key/mock callers |
