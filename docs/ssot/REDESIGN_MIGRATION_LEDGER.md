...
| Web frontend | direct fetches + client API key/mock fallbacks | shared session-authorized API clients + presentation-only UI | PARTIAL / MEMBER + SETTINGS + AUDIT READS MIGRATED | member reads d78a1bc/07ca08e; settings 3ea0171/60b4d35; audit 82cf8ee/481b175 with CI PASS | migrate Reports/write/admin paths; remove remaining client API-key/mock callers |
