...
| LINE webhook ingress | direct LINE → Apps Script + downstream shared secret only | Verified Node ingress → signature verification → Apps Script downstream gate | CODE_VERIFIED / CUTOVER PENDING | gateway 110de3e CI #1; Apps Script privacy 9019873 CI #135; verifier parity 74d8a447 CI #9/#10; deployment-contract drift guard b1de92da CI #11/#12; base-image digest pin 94839c90 CI #13/#14; secure downstream transport 4947bed7 CI #15/#16; public response boundary 74188a7a CI #17/#18; deterministic body-limit boundary 3e655d51 PR CI #21/main CI #22; GitHub Actions immutable pins c80417f4 PR CI #23/main CI #24; slow-client timeout boundary @ 51075b6c PR CI #25/main CI #26; immutable image publish #10: ghcr.io/idev006/mtp6linecoopbot-webhook-ingress:sha-51075b6c3ee4 / ghcr.io/idev006/mtp6linecoopbot-webhook-ingress@sha256:66939f32431c8f0825ba5a2b2599feba9bc93926d1715a23e873abbb9087ddb4 | run repeatable verifier in staging and prove invalid traffic does not reach Apps Script + valid traffic reaches EventHandler; then LINE Console production cutover/monitoring before retiring direct ingress as supported production path |
