...
| LINE webhook ingress | direct LINE → Apps Script + downstream shared secret only | Verified Node ingress → signature verification → Apps Script downstream gate | CODE_VERIFIED / CUTOVER PENDING | gateway 110de3e CI #1; Apps Script privacy 9019873 CI #135; verifier parity 74d8a447 CI #9/#10; deployment-contract drift guard b1de92da CI #11/#12; base-image digest pin 94839c90 CI #13/#14; secure downstream transport @ 4947bed7 CI #15/#16; immutable image publish #6: ghcr.io/idev006/mtp6linecoopbot-webhook-ingress:sha-4947bed7bec3 / ghcr.io/idev006/mtp6linecoopbot-webhook-ingress@sha256:5dfcf5dfa42b9cef6b2d453b7c7924e3c871488178b1d624de7b875a76745fcb | run repeatable verifier in staging and prove invalid traffic does not reach Apps Script + valid traffic reaches EventHandler; then LINE Console production cutover/monitoring before retiring direct ingress as supported production path |
