...
| REQ-REL-WEBHOOK-004 | Webhook release candidate container builds must be reproducible from a reviewed base-image digest and CI must reject an unpinned mutable base | ADR-0005 / REL-WEBHOOK-004 / WEBHOOK_INGRESS_SECURITY_STANDARD / REL-WEBHOOK-001 | Dockerfile pins node:24-alpine to sha256:e67514e5d0f6c46656005e1b693b2ec9d52e80b641307de684d4a015ba7a4eaf; regression guard @ 94839c90; immutable candidate ghcr.io/idev006/mtp6linecoopbot-webhook-ingress:sha-94839c90d340; digest ghcr.io/idev006/mtp6linecoopbot-webhook-ingress@sha256:e7e567e14b155d8bfd093878297361e9a7baedc10108c3571e3550d1d5ef1b33 | Webhook Ingress CI #13 PR PASS; PR #130 merged; main CI #14 PASS; Publish Webhook Ingress Image #5 PASS | VERIFIED / SUPPLY-CHAIN HARDENING COMPLETE; CUTOVER STILL PENDING UNDER #68 |


| REQ-REL-WEBHOOK-005 | Gateway downstream transport carrying the independent downstream secret must fail closed unless configured over clean HTTPS, with no embedded credentials or fragment, and redirects must remain disabled | ADR-0005 / REL-WEBHOOK-005 / WEBHOOK_INGRESS_SECURITY_STANDARD / REL-WEBHOOK-001 | secure DOWNSTREAM_URL validation + regression cases @ 4947bed7; immutable candidate ghcr.io/idev006/mtp6linecoopbot-webhook-ingress:sha-4947bed7bec3; digest ghcr.io/idev006/mtp6linecoopbot-webhook-ingress@sha256:5dfcf5dfa42b9cef6b2d453b7c7924e3c871488178b1d624de7b875a76745fcb | Webhook Ingress CI #15 PR PASS; PR #133 merged; main CI #16 PASS; Publish Webhook Ingress Image #6 PASS | VERIFIED / TRANSPORT HARDENING COMPLETE; CUTOVER STILL PENDING UNDER #68 |


| REQ-REL-WEBHOOK-006 | Verified downstream response bodies must never be reflected through the public webhook ingress; public success response must be gateway-owned and downstream non-2xx must remain fail-closed | ADR-0005 / REL-WEBHOOK-006 / WEBHOOK_INGRESS_SECURITY_STANDARD / REL-WEBHOOK-001 | response-boundary implementation + unit/HTTP integration regressions @ 74188a7a; immutable candidate ghcr.io/idev006/mtp6linecoopbot-webhook-ingress:sha-74188a7aa6cf; digest ghcr.io/idev006/mtp6linecoopbot-webhook-ingress@sha256:5c59e308f4faa59b05f15ac84d987bb7eb0a2c3314ce42af571160009c87aa70 | Webhook Ingress CI #17 PR PASS; PR #136 merged; main CI #18 PASS; Publish Webhook Ingress Image #7 PASS | VERIFIED / RESPONSE-BOUNDARY HARDENING COMPLETE; CUTOVER STILL PENDING UNDER #68 |


| REQ-REL-WEBHOOK-007 | Public webhook ingress must enforce the existing 1 MiB body-memory bound deterministically: non-POST rejected before body collection; declared/streamed oversize returns 413; no rejected case reaches signature processing/downstream | ADR-0005 / REL-WEBHOOK-007 / WEBHOOK_INGRESS_SECURITY_STANDARD / REL-WEBHOOK-001 | HTTP-boundary implementation + full HTTP regressions @ 3e655d51; immutable candidate ghcr.io/idev006/mtp6linecoopbot-webhook-ingress:sha-3e655d51fa99; digest ghcr.io/idev006/mtp6linecoopbot-webhook-ingress@sha256:7184dac64af8e77fc5dac3cfdd0a4953523313bcafc3161571d59ed60a62c8ab | PR CI #19/#20 failed and drove root-cause/test-fixture corrections; CI #21 PASS; PR #139 merged; main CI #22 PASS; Publish Webhook Ingress Image #8 PASS | VERIFIED / HTTP BODY-LIMIT HARDENING COMPLETE; CUTOVER STILL PENDING UNDER #68 |


| REQ-REL-WEBHOOK-008 | Webhook release workflows must pin every external GitHub Action to an immutable commit SHA, and image-publish workflow changes must pass webhook CI before merge | ADR-0005 / REL-WEBHOOK-008 / WEBHOOK_INGRESS_SECURITY_STANDARD / REL-WEBHOOK-001 | checkout pin 11d5960a326750d5838078e36cf38b85af677262; setup-node pin 49933ea5288caeca8642d1e84afbd3f7d6820020; regression guard + PR trigger coverage @ c80417f4; immutable candidate ghcr.io/idev006/mtp6linecoopbot-webhook-ingress:sha-c80417f430c0; digest ghcr.io/idev006/mtp6linecoopbot-webhook-ingress@sha256:b238c42a81fe9be020ed55d08858428d06fee80a66884631a3aea7454ab5a93a | Webhook Ingress CI #23 PR PASS; PR #142 merged; main CI #24 PASS; Publish Webhook Ingress Image #9 PASS | VERIFIED / ACTION SUPPLY-CHAIN HARDENING COMPLETE; CUTOVER STILL PENDING UNDER #68 |


| REQ-REL-WEBHOOK-009 | Public webhook ingress must explicitly bound slow/incomplete client connections instead of relying on broad Node HTTP defaults, while preserving independent downstream timeout semantics | ADR-0005 / REL-WEBHOOK-009 / WEBHOOK_INGRESS_SECURITY_STANDARD / REL-WEBHOOK-001 | Node HTTP request/header/check/keep-alive timeout contract + runtime server regression @ 51075b6c; immutable candidate ghcr.io/idev006/mtp6linecoopbot-webhook-ingress:sha-51075b6c3ee4; digest ghcr.io/idev006/mtp6linecoopbot-webhook-ingress@sha256:66939f32431c8f0825ba5a2b2599feba9bc93926d1715a23e873abbb9087ddb4 | Webhook Ingress CI #25 PR PASS; PR #145 merged; main CI #26 PASS; Publish Webhook Ingress Image #10 PASS | VERIFIED / INGRESS TIMEOUT HARDENING COMPLETE; CUTOVER STILL PENDING UNDER #68 |


| REQ-REL-WEBHOOK-010 | Public webhook ingress must reject missing or syntactically invalid LINE signatures before body collection while retaining exact raw-body HMAC verification for well-formed signatures | ADR-0005 / REL-WEBHOOK-010 / WEBHOOK_INGRESS_SECURITY_STANDARD / REL-WEBHOOK-001 | canonical signature-format validator + HTTP pre-body rejection + handler defense-in-depth @ 6dcb1b40; immutable candidate ghcr.io/idev006/mtp6linecoopbot-webhook-ingress:sha-6dcb1b405c70; digest ghcr.io/idev006/mtp6linecoopbot-webhook-ingress@sha256:82757d01edc1f68911475321d0069fe38acb07eea9f72d9963ada1a6c24263c1 | PR CI #27 failed on test import wiring and was corrected; CI #28 PR PASS; PR #148 merged; main CI #29 PASS; Publish Webhook Ingress Image #11 PASS | VERIFIED / PRE-BODY SIGNATURE HARDENING COMPLETE; CUTOVER STILL PENDING UNDER #68 |


| REQ-REL-WEBHOOK-011 | Downstream timeout configuration must fail closed unless it is an integer in the bounded range 100–30000 ms, preserving the default 8000 ms and existing abort-on-timeout behavior | ADR-0005 / REL-WEBHOOK-011 / WEBHOOK_INGRESS_SECURITY_STANDARD / REL-WEBHOOK-001 | config bounds + deployment-contract regressions + operator docs @ 3eb75cd7; immutable candidate ghcr.io/idev006/mtp6linecoopbot-webhook-ingress:sha-3eb75cd7f80c; digest ghcr.io/idev006/mtp6linecoopbot-webhook-ingress@sha256:f727b5f231907dff42604aa49395c40afee97778ead8a951f4e8c55bc2fc0d9d | Webhook Ingress CI #30 PR PASS; PR #151 merged; main CI #31 PASS; Publish Webhook Ingress Image #12 PASS | VERIFIED / DOWNSTREAM TIMEOUT CONFIG HARDENING COMPLETE; CUTOVER STILL PENDING UNDER #68 |


| REQ-REL-WEBHOOK-012 | LINE channel secret and gateway downstream secret must be independent runtime values; identical values must fail startup without exposing secret material | ADR-0005 / REL-WEBHOOK-012 / WEBHOOK_INGRESS_SECURITY_STANDARD / WEBHOOK_INGRESS_DEPLOYMENT_RUNBOOK / REL-WEBHOOK-001 | config secret-independence invariant + regression coverage + operator docs @ f8e1db76; immutable candidate ghcr.io/idev006/mtp6linecoopbot-webhook-ingress:sha-f8e1db769d5f; digest ghcr.io/idev006/mtp6linecoopbot-webhook-ingress@sha256:30f32c3d88b59001cdf17a9e872882d82e5923ddd651a50406fc893aa4d0cbde | Webhook Ingress CI #32 PR PASS; PR #154 merged; main CI #33 PASS; Publish Webhook Ingress Image #13 PASS | VERIFIED / SECRET INDEPENDENCE HARDENING COMPLETE; CUTOVER STILL PENDING UNDER #68 |


| REQ-REL-WEBHOOK-013 | Webhook release workflows must use reviewed immutable action commits whose own runtime targets Node 24, rather than relying on runner-side forced migration from Node 20 | REL-WEBHOOK-013 / WEBHOOK_INGRESS_SECURITY_STANDARD / REL-WEBHOOK-001 | checkout v7.0.1 @ 3d3c42e5aac5ba805825da76410c181273ba90b1; setup-node v7.0.0 @ 820762786026740c76f36085b0efc47a31fe5020; regression guard against prior v4 commits; immutable candidate ghcr.io/idev006/mtp6linecoopbot-webhook-ingress:sha-352fc705612c; digest ghcr.io/idev006/mtp6linecoopbot-webhook-ingress@sha256:22ca6733eea5d1747bd2ecf52a5dbc060e173d1281ba5ef85f340e0d1fb99f8e | Webhook Ingress CI #34 PR PASS; PR #157 merged; main CI #35 PASS with no Node 20 deprecation warning; Publish Webhook Ingress Image #14 PASS | VERIFIED / NATIVE NODE 24 RELEASE ACTION UPGRADE COMPLETE; CUTOVER STILL PENDING UNDER #68 |
